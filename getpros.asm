...
_getpros:     file format elf32-i386
...
int main (void)
{
  ...
  11:	e8 5c 03 00 00       	call   372 <getpros>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 80 07 00 00       	push   $0x780
  1f:	6a 01                	push   $0x1
  21:	e8 0a 04 00 00       	call   430 <printf>
  printf(1, "Soy el proceso Padre.\n");
  26:	58                   	pop    %eax
  27:	5a                   	pop    %edx
  28:	68 66 07 00 00       	push   $0x766
  2d:	6a 01                	push   $0x1
...
void fork_de_prueba(void)
{
  ...
  34:	59                   	pop    %ecx
  35:	58                   	pop    %eax
  36:	68 50 07 00 00       	push   $0x750
  3b:	6a 01                	push   $0x1
  3d:	e8 ee 03 00 00       	call   430 <printf>
  fork();
  42:	e8 83 02 00 00       	call   2ca <fork>
int main (void)
{
  printf(1, "Hay actualmente %d procesos, gracias por consultar.\n", getpros()); // LLAMADA A SISTEMA
  printf(1, "Soy el proceso Padre.\n");
  ...
  47:	e8 26 03 00 00       	call   372 <getpros>
...
void fork_de_prueba(void)
{
  ...
  printf(1, "Soy el proceso Hijo.\n");
  76:	68 50 07 00 00       	push   $0x750
  7b:	6a 01                	push   $0x1
  7d:	e8 ae 03 00 00       	call   430 <printf>
  fork();
...
void fork_de_prueba(void)
{
  printf(1, "Soy el proceso Hijo.\n");
  fork();
  86:	e9 3f 02 00 00       	jmp    2ca <fork>
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
  8f:	90                   	nop
...
00000372 <getpros>:
SYSCALL(getpros) // DEFINICION EN USYS
 372:	b8 16 00 00 00       	mov    $0x16,%eax
 377:	cd 40                	int    $0x40
 379:	c3                   	ret    

0000037a <settickets>:
SYSCALL(settickets) // COLOCA TICKETS
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 ec 07 00 00       	mov    $0x7ec,%eax
...
free(void *ap)
{
 ...
 5d1:	a1 ac 0a 00 00       	mov    0xaac,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 ac 0a 00 00       	mov    %eax,0xaac
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 ac 0a 00 00    	cmp    %eax,0xaac
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 72d:	0a 00 00 
 730:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 73f:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 746:	00 00 00 
